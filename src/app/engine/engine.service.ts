...
export class EngineService {
  ...
  createScene(elementId: string): void {
    ...
    let i, cube, material, p, parameters = [[0.25, 0x000000, 2], [0.5, 0x000000, 2], [0.75, 0x000000, 0.75], [1, 0x000000, 0.5], [1.25, 0x000000, 0.8],
    ...
    for (i = 0; i < parameters.length; ++i) {
      p = parameters[i];
      material = new THREE.MeshBasicMaterial({ color: p[1], opacity: p[2] });
      ...
      cube.rotation.x = Math.random() * (Math.PI / 6);
      cube.updateMatrix();
      this.scene.add(cube);
